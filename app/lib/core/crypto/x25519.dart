/// @file        x25519.dart
/// @description X25519 Diffie-Hellman key exchange and Ed25519->X25519 key conversion. Built on pinenacl TweetNaCl
/// @author      Kennt Kim
/// @company     Calida Lab
/// @created     2026-03-30
...
///
/// @functions
///  - X25519KeyPair: X25519 keypair data class
///  - X25519KeyPair.generate(): Generate a new X25519 keypair
///  - x25519Dh(privateKey, publicKey): raw X25519 DH (crypto_scalarmult)
///  - ed25519PublicKeyToX25519(ed25519PublicKey): Convert Ed25519 public key to X25519
///  - ed25519PrivateKeyToX25519(ed25519PrivateSeed): Convert Ed25519 private key to X25519
