...
/// @description Double Ratchet algorithm implementation. Provides per-message forward and post-compromise (backward) secrecy
/// @author      Kennt Kim
/// @company     Calida Lab
/// @created     2026-03-30
...
///
/// @functions
///  - EncryptedMessage: Encrypted message data class (ciphertext + ratchet key + message number)
///  - DoubleRatchetSession: Double Ratchet session state and encrypt/decrypt class
///  - DoubleRatchetSession.initSender(): Initialize sender session with X3DH shared secret
///  - DoubleRatchetSession.initReceiver(): Initialize receiver session with X3DH shared secret
///  - DoubleRatchetSession.encrypt(): Encrypt plaintext and return EncryptedMessage
///  - DoubleRatchetSession.decrypt(): Decrypt EncryptedMessage and return plaintext
///  - DoubleRatchetSession.toJson(): Serialize session state
///  - DoubleRatchetSession.fromJson(): Deserialize session state
