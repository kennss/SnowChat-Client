...
/// @description SKDM distribution tracker — tracks per-member Sender Key distribution state to avoid redundant re-sends
/// @author      Kennt Kim
/// @company     Calida Lab
/// @created     2026-04-04
...
///
/// @functions
///  - SenderKeyDistributionTracker: SKDM distribution tracking class
///  - needsSKDM(): Decide whether SKDM needs to be sent to a given member
///  - markDelivered(): Record successful SKDM delivery
///  - invalidateGroup(): Reset tracking for the entire group on key rotation
///  - removeMember(): Remove tracking for a member on member removal
///  - toJson(): Serialize for persistence
///  - fromJson(): Restore persisted state
