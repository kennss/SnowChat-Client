/// @file        hkdf.dart
/// @description HMAC-SHA256 based HKDF (RFC 5869) key derivation function. Used for Signal Protocol key derivation
/// @author      Kennt Kim
/// @company     Calida Lab
/// @created     2026-03-30
...
///
/// @functions
///  - hmacSha256(key, data): Compute HMAC-SHA256
///  - hkdfExtract(salt, ikm): HKDF Extract step
///  - hkdfExpand(prk, info, length): HKDF Expand step
///  - hkdfDerive(ikm, salt, info, length): Combined HKDF Extract + Expand
